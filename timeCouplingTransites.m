...
for subid=1:1:length(allFiles)
    ...
    for mi=2:1:numel(binM)
        if binM(mi-1)==121 && binM(mi)==34
            binTr(mi)=1;
        end
        if binM(mi-1)==34 && binM(mi)==121
            binTr(mi)=2;
        end
        if binM(mi-1)==121 && binM(mi)==82
            binTr(mi)=1;
        end
        if binM(mi-1)==82 && binM(mi)==121
            binTr(mi)=2;
        end        
        if binM(mi-1)==121 && binM(mi)==136
            binTr(mi)=1;
        end
        if binM(mi-1)==136 && binM(mi)==121
            binTr(mi)=2;
        end
        if binM(mi-1)==121 && binM(mi)==175
            binTr(mi)=1;
        end
        if binM(mi-1)==175 && binM(mi)==121
            binTr(mi)=2;
        end
        if binM(mi-1)==121 && binM(mi)==223
            binTr(mi)=1;
        end
        if binM(mi-1)==223 && binM(mi)==121
            binTr(mi)=2;
        end        
